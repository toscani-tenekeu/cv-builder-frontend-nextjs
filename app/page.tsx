      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="relative w-full max-w-md aspect-[3/4] rounded-xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 bg-white dark:bg-zinc-900 z-0 p-6 overflow-auto">
              {/* CV Preview Content */}
              <div className="flex flex-col items-center text-center mb-4 pb-4 border-b">
                ...
                <p className="text-teal-600 font-medium">Développeuse Full Stack</p>
              ...
              <div className="mb-4">
                <h2 className="text-lg font-semibold mb-1 text-teal-600 border-b pb-1">Résumé</h2>
                <p className="text-sm">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  <h2 className="text-lg font-semibold mb-1 text-teal-600 border-b pb-1">Expérience professionnelle</h2>
                ...
                <div>
                  <h2 className="text-lg font-semibold mb-1 text-teal-600 border-b pb-1">Formation</h2>
                  <div>
                ...
                <div>
                  <h2 className="text-lg font-semibold mb-1 text-teal-600 border-b pb-1">Compétences</h2>
                ...
                <div>
                  <h2 className="text-lg font-semibold mb-1 text-teal-600 border-b pb-1">Langues</h2>
              ...
              <div className="absolute bottom-4 right-4 opacity-50">
                <Badge className="bg-teal-600">CV Builder</Badge>
              </div>
            </div>
          </div>
        </motion.div>
