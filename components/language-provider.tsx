...
const translations = {
  fr: {
    ...
    "hero.createOnSite": "Créer sur le site",
    ...
    "cta.createOnSite": "Créer sur le site",
    ...
    "pricing.weekly.name": "Premium",
    "pricing.weekly.price": "1 399 FCFA",
    "pricing.weekly.description": "Accès complet pendant 24h",
    "pricing.weekly.feature1": "CV illimités (pendant 24h)",
    "pricing.weekly.feature2": "Lettre de motivation gratuite (01)",
    "pricing.weekly.feature3": "Tous les modèles premium",
    "pricing.weekly.feature4": "Exportation en PDF et DOCX",
    "pricing.weekly.feature5": "Accès basique à Tosca AI",
    "pricing.weekly.feature6": "Création plus automatique",
    "pricing.weekly.feature7": "Support prioritaire",
    "pricing.weekly.button": "Acheter (1 jour)",

    "pricing.monthly.name": "Gold",
    "pricing.monthly.price": "3 499 FCFA",
    "pricing.monthly.description": "Accès complet pendant 24h",
    "pricing.monthly.feature1": "Toutes les fonctionnalités du plan Premium",
    "pricing.monthly.feature2": "Création avancée via lien, document ou image contenant vos informations",
    "pricing.monthly.feature3": "Lettre de motivation (tous les modèles)",
    "pricing.monthly.feature4": "Accès complet à Tosca AI",
    "pricing.monthly.feature5": "Lien de partage sécurisé pour collaborer sur vos CV",
    "pricing.monthly.feature6": "Exportation avancée (PDF, DOCX, SVG)",
    "pricing.monthly.feature7": "Portfolio CV en ligne (HTML + CSS)",
    "pricing.monthly.feature8": "Support prioritaire 24/7",
    "pricing.monthly.feature9": "Conseils personnalisés d'experts",
    "pricing.monthly.button": "Acheter (1 jour)",

    "pricing.promax.name": "Gold PRO MAX",
    "pricing.promax.price": "19 499 FCFA",
    "pricing.promax.description": "Accès complet pendant 1 an",
    "pricing.promax.feature1": "Toutes les fonctionnalités du plan Gold",
    "pricing.promax.feature2": "Mises à jour gratuites pendant 1 an",
    "pricing.promax.button": "Acheter (1 an)",
  ...
  en: {
    ...
    "hero.createOnSite": "Create on site",
    ...
    "cta.createOnSite": "Create on site",
    ...
    "pricing.daily.name": "Basic",
    "pricing.daily.price": "600 FCFA",
    "pricing.daily.description": "Full access for 24 hours",
    "pricing.daily.feature1": "Unlimited CVs (for 24h)",
    ...
    "pricing.weekly.name": "Premium",
    "pricing.weekly.price": "1,399 FCFA",
    "pricing.weekly.description": "Full access for 24 hours",
    "pricing.weekly.feature1": "Unlimited CVs (for 24h)",
    "pricing.weekly.feature2": "Free cover letter (01)",
    "pricing.weekly.feature3": "All premium templates",
    "pricing.weekly.feature4": "PDF and DOCX export",
    "pricing.weekly.feature5": "Basic access to Tosca AI",
    "pricing.weekly.feature6": "Enhanced automatic creation",
    "pricing.weekly.feature7": "Priority support",
    "pricing.weekly.button": "Buy (1 day)",

    "pricing.monthly.name": "Gold",
    "pricing.monthly.price": "3,499 FCFA",
    "pricing.monthly.description": "Full access for 24 hours",
    "pricing.monthly.feature1": "All features from the Premium plan",
    "pricing.monthly.feature2": "Advanced creation from links, documents or images containing your information",
    "pricing.monthly.feature3": "Cover letter (all templates)",
    "pricing.monthly.feature4": "Full access to Tosca AI",
    "pricing.monthly.feature5": "Secure sharing links to collaborate on your CVs",
    "pricing.monthly.feature6": "Advanced export formats (PDF, DOCX, SVG)",
    "pricing.monthly.feature7": "Online CV portfolio (HTML + CSS)",
    "pricing.monthly.feature8": "24/7 priority support",
    "pricing.monthly.feature9": "Personalized expert advice",
    "pricing.monthly.button": "Buy (1 day)",

    "pricing.promax.name": "Gold PRO MAX",
    "pricing.promax.price": "19,499 FCFA",
    "pricing.promax.description": "Full access for 1 year",
    "pricing.promax.feature1": "All features from the Gold plan",
    "pricing.promax.feature2": "Free updates for 1 year",
    "pricing.promax.button": "Buy (1 year)",
